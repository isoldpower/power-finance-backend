...
from ..transaction_created.__tests__.fakes import SingleLegDispatcher
from .fakes import (
    TRANSACTION_ID,
    USER_ID,
...
async def _dispatch_created(build_dispatcher=build_created_dispatcher) -> None:
    await transaction_created.DispatchPostings(build_dispatcher).apply(
