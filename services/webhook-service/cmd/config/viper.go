...
// ResolveViper configures Viper paths to be further utilised.
...
// TryResolveConfig reads the Viper config at configured paths after ResolveViper.
...
// SplitViperPath breaks down the path into directory, file name and file type.
