...
func (x *UserSynced) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSynced) ProtoMessage() {}

func (x *UserSynced) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use UserSynced.ProtoReflect.Descriptor instead.
func (*UserSynced) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{0}
}

func (x *UserSynced) GetEventId() string {
	if x != nil {
		return x.EventId
	}
	return ""
...
func (x *UserSynced) GetOccurredAt() *timestamppb.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
func (x *UserSynced) GetSchemaVersion() int32 {
	if x != nil {
...
func (x *UserSynced) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *UserSynced) GetExternalId() string {
	if x != nil {
		return x.ExternalId
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x17power_finance.events.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x01\n" +
	"\n" +
	"UserSynced\x12\x19\n" +
...
var file_user_proto_goTypes = []any{
	(*UserSynced)(nil),            // 0: power_finance.events.v1.UserSynced
	(*timestamppb.Timestamp)(nil), // 1: google.protobuf.Timestamp
}
var file_user_proto_depIdxs = []int32{
	1, // 0: power_finance.events.v1.UserSynced.occurred_at:type_name -> google.protobuf.Timestamp
