"""Shared test doubles for kafka_client_py: a stand-in message and an
in-memory publisher that records every call.

Lifted out of conftest.py so test files can import them by name without
relying on conftest's pytest-magic location. Conftest is reserved for
fixtures.
"""
